...
# -6.770853 14.360708 1.421385
# -6.664255 15.79024 3.862700
# -6.859162 18.303812 -2.745892
# -5.589580 16.523210 -0.542670

## retest points in current 
...
GOALS = [
    ...
    #  (-6.174421, 15.932986, -2.160590),
    #  (-6.174421, 15.932986, 0.981003),
    #  (-6.187276, 17.698249, 1.850363),
    #  (-5.681454, 18.732806, -0.255332),
    ...
    try:
        ...
        for idx, (x, y, yaw) in enumerate(GOALS, start=1):
            ...
            if out is None or out[0] != GoalStatus.STATUS_SUCCEEDED:
                ...
                print("test sleep------failddddddddddddddddddddddddddddddddddddddddd")
                time.sleep(5)
                continue
